...
public class HsUVar extends HsSymbolReference{
	
	public HsUVar(@NotNull ASTNode node){
		super(node);
	}
	...
	public @NotNull Collection<? extends Symbol> resolveReference(){
		// TODO: proper resolution rules
		return BindingSearcher.topLevelByName(getProject(), name()).collect(Collectors.toSet());
	}
